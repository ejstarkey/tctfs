"""
Western Pacific Basin Parser - Parse WP history files.
"""
import re
...
class WesternPacificParser(BaseHistoryParser):
    """
    Parser for Western Pacific basin *-list.txt files.
    """
    
    def parse_line(self, line: str) -> Optional[Dict]:
        """
        Parse a line from WP basin history file.
        
        Expected format (varies, but generally):
        YYYYMMDD HHMM LAT LON VMAX MSLP [additional fields]
        """
        parts = line.split()
