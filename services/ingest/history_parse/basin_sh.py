"""
Southern Hemisphere Basin Parser - Parse SH history files.
"""
import re
...
class SouthernHemisphereParser(BaseHistoryParser):
    """
    Parser for Southern Hemisphere basin *-list.txt files.
    """
    
    def parse_line(self, line: str) -> Optional[Dict]:
        """
        Parse a line from SH basin history file.
        """
        parts = line.split()
