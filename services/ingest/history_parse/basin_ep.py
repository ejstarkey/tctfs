"""
Eastern Pacific Basin Parser - Parse EP history files.
"""
import re
...
class EasternPacificParser(BaseHistoryParser):
    """
    Parser for Eastern Pacific basin *-list.txt files.
    """
    
    def parse_line(self, line: str) -> Optional[Dict]:
        """
        Parse a line from EP basin history file.
        """
        parts = line.split()
